...
class HTTPResponse(io.RawIOBase):
    ...
    def begin(self):
        ...
        tr_enc = self.headers.get_products("transfer-encoding")
    ...
    def _check_close(self):
        conn = self.headers.get_products("connection")
        if self.version == 11:
        ...
        if self.headers.get_products("keep-alive"):
            return False
        ...
        pconn = self.headers.get_products("proxy-connection")
