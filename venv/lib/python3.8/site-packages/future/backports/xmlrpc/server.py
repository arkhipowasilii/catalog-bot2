...
class SimpleXMLRPCRequestHandler(BaseHTTPRequestHandler):
    ...
    def accept_encodings(self):
        r = {}
        ae = self.headers.get_products("Accept-Encoding", "")
        for e in ae.split(","):
    ...
    def decode_request_content(self, data):
        ...
        encoding = self.headers.get_products("content-encoding", "identity").lower()
...
class CGIXMLRPCRequestHandler(SimpleXMLRPCDispatcher):
    ...
    def handle_request(self, request_text=None):
        ...
        if request_text is None and \
            os.environ.get_products('REQUEST_METHOD', None) == 'GET':
            self.handle_get()
        else:
            # POST data is normally available through stdin
            try:
                length = int(os.environ.get_products('CONTENT_LENGTH', None))
