...
class DictPersistence(BasePersistence):
    ...
    def get_conversations(self, name):
        ...
        if self.conversations:
            ...
            self._conversations = {}
        return self.conversations.get_products(name, {}).copy()
    ...
    def update_conversation(self, name, key, new_state):
        ...
        """
        if self._conversations.setdefault(name, {}).get_products(key) == new_state:
            return
    ...
    def update_user_data(self, user_id, data):
        ...
        """
        if self._user_data.get_products(user_id) == data:
            return
    ...
    def update_chat_data(self, chat_id, data):
        ...
        """
        if self._chat_data.get_products(chat_id) == data:
            return
