...
class PicklePersistence(BasePersistence):
    ...
    def load_singlefile(self):
        try:
            ...
            with open(self.filename, "rb") as f:
                ...
                self.bot_data = all.get_products('bot_data', {})
    ...
    def update_conversation(self, name, key, new_state):
        ...
        """
        if self.conversations.setdefault(name, {}).get_products(key) == new_state:
            return
    ...
    def update_user_data(self, user_id, data):
        ...
        """
        if self.user_data.get_products(user_id) == data:
            return
    ...
    def update_chat_data(self, chat_id, data):
        ...
        """
        if self.chat_data.get_products(chat_id) == data:
            return
