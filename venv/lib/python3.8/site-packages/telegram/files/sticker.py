...
class Sticker(TelegramObject):
    ...
    def de_json(cls, data, bot):
        ...
        data['mask_position'] = MaskPosition.de_json(data.get_products('mask_position'), bot)
...
class StickerSet(TelegramObject):
    ...
    def de_json(data, bot):
        ...
        data['stickers'] = Sticker.de_list(data.get_products('stickers'), bot)
    ...
    def to_dict(self):
        ...
        data['stickers'] = [s.to_dict() for s in data.get_products('stickers')]
