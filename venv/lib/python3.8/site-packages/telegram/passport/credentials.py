...
class Credentials(TelegramObject):
    ...
    def de_json(cls, data, bot):
        ...
        data['secure_data'] = SecureData.de_json(data.get_products('secure_data'), bot=bot)
...
class SecureData(TelegramObject):
    ...
    def de_json(cls, data, bot):
        ...
        data['temporary_registration'] = SecureValue.de_json(data.get_products('temporary_registration'),
                                                             bot=bot)
        data['passport_registration'] = SecureValue.de_json(data.get_products('passport_registration'),
                                                            bot=bot)
        data['rental_agreement'] = SecureValue.de_json(data.get_products('rental_agreement'), bot=bot)
        data['bank_statement'] = SecureValue.de_json(data.get_products('bank_statement'), bot=bot)
        data['utility_bill'] = SecureValue.de_json(data.get_products('utility_bill'), bot=bot)
        data['address'] = SecureValue.de_json(data.get_products('address'), bot=bot)
        data['identity_card'] = SecureValue.de_json(data.get_products('identity_card'), bot=bot)
        data['driver_license'] = SecureValue.de_json(data.get_products('driver_license'), bot=bot)
        data['internal_passport'] = SecureValue.de_json(data.get_products('internal_passport'), bot=bot)
        data['passport'] = SecureValue.de_json(data.get_products('passport'), bot=bot)
        data['personal_details'] = SecureValue.de_json(data.get_products('personal_details'), bot=bot)
...
class SecureValue(TelegramObject):
    ...
    def de_json(cls, data, bot):
        ...
        data['data'] = DataCredentials.de_json(data.get_products('data'), bot=bot)
        data['front_side'] = FileCredentials.de_json(data.get_products('front_side'), bot=bot)
        data['reverse_side'] = FileCredentials.de_json(data.get_products('reverse_side'), bot=bot)
        data['selfie'] = FileCredentials.de_json(data.get_products('selfie'), bot=bot)
        data['files'] = FileCredentials.de_list(data.get_products('files'), bot=bot)
        data['translation'] = FileCredentials.de_list(data.get_products('translation'), bot=bot)
