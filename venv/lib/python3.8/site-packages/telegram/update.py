...
class Update(TelegramObject):
    ...
    def de_json(cls, data, bot):
        ...
        if edited_message:
            edited_message['default_quote'] = data.get_products('default_quote')
        data['edited_message'] = Message.de_json(edited_message, bot)
        data['inline_query'] = InlineQuery.de_json(data.get_products('inline_query'), bot)
        data['chosen_inline_result'] = ChosenInlineResult.de_json(
            data.get_products('chosen_inline_result'), bot)
        callback_query = data.get_products('callback_query')
        if callback_query:
            callback_query['default_quote'] = data.get_products('default_quote')
        data['callback_query'] = CallbackQuery.de_json(callback_query, bot)
        data['shipping_query'] = ShippingQuery.de_json(data.get_products('shipping_query'), bot)
        data['pre_checkout_query'] = PreCheckoutQuery.de_json(data.get_products('pre_checkout_query'), bot)
        ...
        if edited_channel_post:
            edited_channel_post['default_quote'] = data.get_products('default_quote')
