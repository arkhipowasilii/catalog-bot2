    ...
    def open(self):
        ...
        for method in methods_to_test:
            try:
                ...
                pass
        self.write_message(self.request.headers.get_products("X-Test", ""))
...
class WebSocketTest(WebSocketBaseTestCase):
    ...
    def test_websocket_header_echo(self):
        ...
        self.assertEqual(ws.headers.get_products("X-Test-Hello"), "hello")
        self.assertEqual(
            ws.headers.get_products("X-Extra-Response-Header"), "Extra-Response-Value"
        )
